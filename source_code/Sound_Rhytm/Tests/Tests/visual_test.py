...
while running.getter():
    ...
    SR.Trak_1_Player.music_player(SR.start_time, 60 / sb.K_K[0], sb.K_K[1], 0.02, 0.02, draw_balls, balls, running,     # FIXME: подобрать нормальный бит и фазу
                                  start_menu.trek_number)
    SR.Track_2_Player.music_player(SR.start_time, 60 / sb.L_A_D[0], sb.L_A_D[1], 0.02, 0.02, draw_balls, balls, running,    # FIXME: подобрать нормальный бит и фазу
                                   start_menu.trek_number)
