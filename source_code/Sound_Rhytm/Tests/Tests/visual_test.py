...
while running.getter():
    ...
    SR.Trak_1_Player.music_player(SR.start_time, 60 / sb.K_K[0], sb.K_K[1], 0.01, 0.01, draw_balls, balls, running,
                                  start_menu.trek_number)
    SR.Track_2_Player.music_player(SR.start_time, 60 / sb.L_A_D[0], sb.L_A_D[1], 0.01, 0.01, draw_balls, balls, running,
                                   start_menu.trek_number)
