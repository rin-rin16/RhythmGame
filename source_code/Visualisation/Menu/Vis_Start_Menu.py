...
class DrawAMenuButton:
    ...
    def draw_start_button_unpressed(self):
        ...
        start = font.render('Start', True, pink, light_grey)
        self.surface.blit(start, (480, 200))

    def draw_start_button_pressed(self):
        font = pg.font.Font(os.path.join(os.getcwd(), "source_code", "Visualisation", "Menu", 'Sunset Club Free Trial.ttf'), 160)
        start = font.render('Start', True, pink, dark_grey)
    ...
    def draw_quit_button_unpressed(self):
        ...
        start = font.render('Quit', True, pink, light_grey)
        self.surface.blit(start, (555, 450))

    def draw_quit_button_pressed(self):
        font = pg.font.Font(os.path.join(os.getcwd(), "source_code", "Visualisation", "Menu", 'Sunset Club Free Trial.ttf'), 120)
        start = font.render('Quit', True, pink, dark_grey)
    ...
    def draw_menu_word(self):
        ...
        menu = font.render('Menu', True, yellow, black)
