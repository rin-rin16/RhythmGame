...
arr_P_T = np.linspace(0, 142, 14200)
l_P_T = []
for i in arr_P_T:
    if (not (((i + sb.P_T[1]) <= 15.7 and
            ...
            (((((i + sb.P_T[1]) % (60 / sb.P_T[0]) <= 0.005) or
               ((i + sb.P_T[1]) % (60 / sb.P_T[0]) >= 60 / sb.P_T[0] - 0.005)))

             or

             ((((((i + sb.P_T[1]) / (60 / sb.P_T[0])) % 16 <= 0.5 + 0.005)) and
               ((((i + sb.P_T[1]) / (60 / sb.P_T[0])) % 16 >= 0.5 - 0.005))))
             and not False
...
arr_W_N = np.linspace(0, 166, 16600)
l_W_N = []
for i in arr_W_N:
    if (
            (i + sb.Y_N[1]) >= 37
            and
            (((i + sb.Y_N[1]) % (60 / sb.Y_N[0]) <= 0.005) or
             ((i + sb.Y_N[1]) % (60 / sb.Y_N[0]) >= 60 / sb.Y_N[0] - 0.005))
    ):
        l_W_N.append(i)
          ...
          ((i + sb.Y_N[1]) <= 36.2
           and
           (((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 3.5 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 3.5 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 2 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 2 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 5 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 5 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 7 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 7 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 1 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 1 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 0 + 0.005) or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 8 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 0.5 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 0.5 - 0.005)))
    ):
        l_W_N.append(i)
          ...
          ((i + sb.Y_N[1]) <= 36.2
           ...
           (((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 3.5 + 0.005) and
            ...
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 7 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 0.75 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 0.75 - 0.005)
            or
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 <= 1.25 + 0.005) and
            ((i + sb.Y_N[1]) / (60 / sb.Y_N[0]) % 8 >= 1.25 - 0.005)))
